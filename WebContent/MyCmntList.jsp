			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="list-group">
						<br>
						<h4>댓글 내역<small> [ ${user_name } ] 님이 등록한 댓글입니다.</small></h4>
								...
								<table class="table table-striped" style="max-width: 1080px;">
						            <thead>
						              <tr>
						                ...
						                <th scope="col" class="mobile" style="width:140px; text-align:center;">등록일자</th>
						              </tr>
						            </thead>
						            <tbody>
									  ...
									  <c:if test="${not empty myCmntList}">
						              <c:forEach var="cmnt" items="${myCmntList }" varStatus="status">
						              <tr>
