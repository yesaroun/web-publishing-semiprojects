                        ...
                        <div class="row">
                            <div class="col-sm-10 m-3">
                                ...
                                <div class="btn-group float-right">
                                    <button type="button" class="btn dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 전체</button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="./AdCmntList.jsp" style="background-color: #F5CAC3; border: none;">전체</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="list-group">
                                    <h4> [전체] <small> 머니리뷰에 게시된 댓글 리스트입니다.</small></h4>
