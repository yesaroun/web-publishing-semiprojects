                ...
                <main id="adNotiList">
                    ...
                    <section>
                        <div class="row" >
                            ...
                            <div class="col-8" style="margin-top: 20px; margin-bottom: 30px;" >
                                <div class="input-group">
                                    <input type="text" class="form-control" style="height: 70px; border: 1px solid;" placeholder="내용을 입력해주세요.">
                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button" style="background-color: skyblue; color: white;" onclick="qnaAnswer()">답변</button>
                                        <button class="btn btn-default" type="button" style="background-color: #F5CAC3; color: white;" onclick="javascript:location.href='<%=cp%>/AdQnaUpdate.jsp'"> 수정</button>
